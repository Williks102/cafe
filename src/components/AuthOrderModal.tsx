  ...
  const renderAuthStep = () => (
    <div className="space-y-6">
      <div className="text-center">
        <User className="w-12 h-12 mx-auto text-amber-600 mb-4" />
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-2 gap-3">
          <Button
            ...
            className={authMode === 'signin' ? 'bg-amber-600 hover:bg-amber-700' : ''}
          >
            Se connecter
          </Button>
          <Button
            ...
            className={authMode === 'signup' ? 'bg-amber-600 hover:bg-amber-700' : ''}
          >
            S'inscrire
          </Button>
        </div>
